...
class AppointmentSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // Créer 30 rendez-vous par clinique
        foreach ($doctors->groupBy('clinic_id') as $clinicId => $clinicDoctors) {
            $clinicPatients = $patients->where('clinic_id', $clinicId);
            $clinicServices = $services->where('clinic_id', $clinicId);
            
            if ($clinicPatients->isEmpty() || $clinicServices->isEmpty()) {
                continue;
            }
