...
@section('title', 'Nouveau Créneau - Docteur')
@section('page-title', 'Nouveau Créneau de Disponibilité')
@section('page-subtitle', 'Ajouter un nouveau créneau de disponibilité')
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">
                        <i class="fas fa-calendar-plus me-2"></i>Informations du créneau
                    </h5>
                </div>
                <div class="card-body">
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <select class="form-select @error('appointment_duration') is-invalid @enderror" 
                                        ...
                                        <option value="15" {{ old('appointment_duration') == '15' ? 'selected' : '' }}>15 minutes</option>
                                        ...
                                        <option value="60" {{ old('appointment_duration') == '60' ? 'selected' : '' }}>1 heure</option>
                                        <option value="90" {{ old('appointment_duration') == '90' ? 'selected' : '' }}>1h30</option>
                                        <option value="120" {{ old('appointment_duration') == '120' ? 'selected' : '' }}>2 heures</option>
                                    </select>
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="alert alert-info">
                        ...
                        <ul class="mb-0">
                            <li>Créez des créneaux de 30-60 minutes</li>
