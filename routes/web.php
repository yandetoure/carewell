...
Route::middleware('auth')->group(function () {
    ...
    Route::group(['prefix' => 'doctor'], function () {
        ...
        Route::get('/calendar', [AbsenceController::class, 'calendar'])->name('doctor.calendar');
        Route::get('/calendar/data', [AbsenceController::class, 'getCalendarData'])->name('doctor.calendar.data');
        Route::get('/calendar/absence/create', [AbsenceController::class, 'create'])->name('doctor.calendar.create-absence');
        Route::post('/calendar/absence', [AbsenceController::class, 'store'])->name('doctor.calendar.store-absence');
        Route::get('/calendar/absence/{absence}/edit', [AbsenceController::class, 'edit'])->name('doctor.calendar.edit-absence');
        Route::put('/calendar/absence/{absence}', [AbsenceController::class, 'update'])->name('doctor.calendar.update-absence');
        Route::delete('/calendar/absence/{absence}', [AbsenceController::class, 'destroy'])->name('doctor.calendar.destroy-absence');
        ...
        Route::put('/profile', [ProfileController::class, 'updateDoctorProfile'])->name('doctor.profile.update');
        Route::put('/profile/password', [ProfileController::class, 'updatePassword'])->name('doctor.profile.password');
        Route::get('/settings', [ProfileController::class, 'doctorSettings'])->name('doctor.settings');
        Route::put('/settings', [ProfileController::class, 'updateDoctorSettings'])->name('doctor.settings.update');
    ...
    Route::group(['prefix' => 'patient'], function () {
        ...
        Route::get('/health-summary', [DashboardController::class, 'patientHealthSummary'])->name('patient.health-summary');
        Route::get('/medical-file', [DashboardController::class, 'patientMedicalFile'])->name('patient.medical-file');
        ...
        Route::get('/vital-signs', [DashboardController::class, 'patientVitalSigns'])->name('patient.vital-signs');
    ...
    Route::group(['prefix' => 'admin'], function () {
        ...
        Route::get('/statistics', [DashboardController::class, 'adminStatistics'])->name('admin.statistics');
        ...
        // Comptabilité
        Route::get('/accounting', [DashboardController::class, 'accounting'])->name('admin.accounting');
        Route::post('/accounting/generate-invoice', [DashboardController::class, 'generateInvoice'])->name('admin.accounting.generate-invoice');
        Route::get('/accounting/export-data', [DashboardController::class, 'exportFinancialData'])->name('admin.accounting.export-data');
        Route::get('/accounting/financial-report', [DashboardController::class, 'generateFinancialReport'])->name('admin.accounting.financial-report');
        ...
        // Lits
        Route::get('/beds', [BedController::class, 'index'])->name('admin.beds');
        Route::get('/beds/index', [BedController::class, 'index'])->name('admin.beds.index');
        Route::get('/beds/{bed}', [BedController::class, 'show'])->name('admin.beds.show');
        Route::get('/beds/{bed}/edit', [BedController::class, 'edit'])->name('admin.beds.edit');
        Route::put('/beds/{bed}', [BedController::class, 'update'])->name('admin.beds.update');
        Route::post('/beds', [BedController::class, 'store'])->name('admin.beds.store');
        Route::delete('/beds/{bed}', [BedController::class, 'destroy'])->name('admin.beds.destroy');

        // Actions supplémentaires pour les lits
        Route::post('/beds/{bed}/admit', [BedController::class, 'admitPatient'])->name('admin.beds.admit');
        Route::post('/beds/{bed}/discharge', [BedController::class, 'dischargePatient'])->name('admin.beds.discharge');
        Route::post('/beds/{bed}/maintenance', [BedController::class, 'setMaintenance'])->name('admin.beds.maintenance');
        Route::post('/beds/{bed}/available', [BedController::class, 'makeAvailable'])->name('admin.beds.available');

        // Pharmacie (Médicaments)
        Route::get('/pharmacy', [DashboardController::class, 'pharmacyStock'])->name('admin.pharmacy');
        Route::get('/pharmacy/{medicament}', [DashboardController::class, 'showMedicament'])->name('admin.pharmacy.show');
        Route::get('/pharmacy/{medicament}/edit', [DashboardController::class, 'editMedicament'])->name('admin.pharmacy.edit');
        Route::put('/pharmacy/{medicament}', [DashboardController::class, 'updateMedicament'])->name('admin.pharmacy.update');
        Route::post('/pharmacy', [DashboardController::class, 'storeMedicament'])->name('admin.pharmacy.store');
        Route::delete('/pharmacy/{medicament}', [DashboardController::class, 'destroyMedicament'])->name('admin.pharmacy.destroy');

        // Prescriptions (Soins médicaux)
        Route::get('/prescriptions', [DashboardController::class, 'prescriptionsManagement'])->name('admin.prescriptions');
        Route::get('/prescriptions/{prescription}', [DashboardController::class, 'showPrescription'])->name('admin.prescriptions.show');
        Route::get('/prescriptions/{prescription}/edit', [DashboardController::class, 'editPrescription'])->name('admin.prescriptions.edit');
        Route::put('/prescriptions/{prescription}', [DashboardController::class, 'updatePrescription'])->name('admin.prescriptions.update');
        Route::post('/prescriptions', [DashboardController::class, 'storePrescription'])->name('admin.prescriptions.store');
        Route::delete('/prescriptions/{prescription}', [DashboardController::class, 'destroyPrescription'])->name('admin.prescriptions.destroy');

        // Ordonnances (Ordonnances médicales avec médicaments)
        Route::get('/ordonnances', [DashboardController::class, 'ordonnancesManagement'])->name('admin.ordonnances');
        Route::get('/ordonnances/{ordonnance}', [DashboardController::class, 'showOrdonnance'])->name('admin.ordonnances.show');
        Route::get('/ordonnances/{ordonnance}/edit', [DashboardController::class, 'editOrdonnance'])->name('admin.ordonnances.edit');
        Route::put('/ordonnances/{ordonnance}', [DashboardController::class, 'updateOrdonnance'])->name('admin.ordonnances.update');
        Route::post('/ordonnances', [DashboardController::class, 'storeOrdonnance'])->name('admin.ordonnances.store');
        ...
        Route::get('/backup', [DashboardController::class, 'adminBackup'])->name('admin.backup');
        Route::get('/tickets', [TicketController::class, 'adminTickets'])->name('admin.tickets');
        Route::get('/faq', [DashboardController::class, 'adminFaq'])->name('admin.faq');
    ...
    Route::group(['prefix' => 'secretary'], function () {
        Route::get('/dashboard', [DashboardController::class, 'secretaryDashboard'])->name('secretary.dashboard');
        Route::get('/statistics', [DashboardController::class, 'secretaryStatistics'])->name('secretary.statistics');
        ...
        Route::get('/patients', [DashboardController::class, 'secretaryPatients'])->name('secretary.patients');
        Route::get('/patients/hospitalized', [DashboardController::class, 'secretaryHospitalizedPatients'])->name('secretary.patients.hospitalized');
        Route::get('/patients/new', [DashboardController::class, 'secretaryCreatePatient'])->name('secretary.patients.new');
        Route::get('/patients/search', [DashboardController::class, 'secretarySearchPatients'])->name('secretary.patients.search');
        Route::get('/medical-files', [MedicalFileController::class, 'secretaryMedicalFiles'])->name('secretary.medical-files');
        Route::get('/doctors', [DashboardController::class, 'secretaryDoctors'])->name('secretary.doctors');
        Route::get('/doctors/{doctor}', [DashboardController::class, 'secretaryDoctorDetails'])->name('secretary.doctors.details');
        ...
        Route::get('/reception', [DashboardController::class, 'secretaryReception'])->name('secretary.reception');
        Route::get('/waiting-list', [DashboardController::class, 'secretaryWaitingList'])->name('secretary.waiting-list');
        Route::get('/check-in', [DashboardController::class, 'secretaryCheckIn'])->name('secretary.check-in');
        ...
        Route::get('/reminders', [DashboardController::class, 'secretaryReminders'])->name('secretary.reminders');
        Route::get('/reports', [DashboardController::class, 'secretaryReports'])->name('secretary.reports');
        Route::get('/billing', [DashboardController::class, 'secretaryBilling'])->name('secretary.billing');
        Route::get('/billing/ticket/{ticket}', [DashboardController::class, 'secretaryTicketDetails'])->name('secretary.billing.ticket');
        Route::put('/billing/ticket/{ticket}/status', [DashboardController::class, 'updateTicketStatus'])->name('secretary.billing.ticket.status');
        Route::put('/billing/tickets/status', [DashboardController::class, 'updateMultipleTicketStatus'])->name('secretary.billing.tickets.status');
        Route::get('/inventory', [DashboardController::class, 'secretaryInventory'])->name('secretary.inventory');
